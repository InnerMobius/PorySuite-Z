...
class SpeciesData(pokemon_data.SpeciesData):
    ...
    def __init__(self, project_info, parent=None):
        ...
        self.add_file_to_backup(
            "src/data/pokemon/species_info.h", file_key="SPECIES_INFO_H"
        )

        # Files to generate must be added second
        self.add_generated_file(
            "src/data/pokemon/species_info/pory_species.h", file_key="PORY_SPECIES_H"
        )
...
class SpeciesGraphics(pokemon_data.SpeciesGraphics):
    ...
    def parse_to_c_code(self):
        super().parse_to_c_code()
        # Graphics are stored directly in species_graphics.json, so there is no
        # corresponding C code to generate here.
        pass
...
class PokemonAbilities(pokemon_data.PokemonAbilities):
    ...
    def parse_to_c_code(self):
        super().parse_to_c_code()
        # Ability data is stored in JSON only; nothing to write back.
        pass
...
class PokemonItems(pokemon_data.PokemonItems):
    ...
    def parse_to_c_code(self):
        super().parse_to_c_code()
        # Items are only kept in JSON for this plugin.
        pass
...
class PokemonMoves(pokemon_data.PokemonMoves):
    ...
    def parse_to_c_code(self):
        super().parse_to_c_code()
        # Move data is kept in JSON and not written back.
        pass
...
class Pokedex(pokemon_data.Pokedex):
    def __init__(self, project_info, parent=None):
        ...
        # Files to back up must be added before parsing occurs
        self.add_file_to_backup(
            "include/constants/pokedex.h", file_key="POKEDEX_H"
        )
    ...
    def parse_to_c_code(self):
        super().parse_to_c_code()
        # Pokédex entries for this plugin are stored only in JSON.
        pass
