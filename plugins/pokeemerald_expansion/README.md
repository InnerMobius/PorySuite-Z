...
PorySuite now runs directly on your machine without using Docker.
Launch the application and select **Pokeemerald Expansion** when creating
a project to use this plugin.
