...
class PorySuitePlugin(ABC):
    ...
    def create_data_manager(project_info: dict, logger=None) -> PokemonDataManager:
        ...
        ``logger`` is an optional callable that accepts a single string. When
        provided, plugins should forward any setup output to this logger so the
        main window can display it in the log pane.
        """
        pass
